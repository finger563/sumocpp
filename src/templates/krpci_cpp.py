...
__CHEETAH_genTime__ = 1436573785.883714
__CHEETAH_genTimestamp__ = 'Fri Jul 10 19:16:25 2015'
__CHEETAH_src__ = '/home/jeb/Repositores/krpci/src/templates/krpci_cpp.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Jul 10 12:57:02 2015'
            ...
            for service in VFFSL(SL,"services",True): # generated from line 5, col 1
                if VFFSL(SL,"service.procedures",True) != []: # generated from line 6, col 1
                    for procedure in VFFSL(SL,"service.procedures",True): # generated from line 7, col 1
                        if VFFSL(SL,"procedure.parameters",True) != []: # generated from line 8, col 1
                            write(u'''bool KRPCI::''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 9, col 13
                            if _v is not None: write(_filter(_v, rawExpr=u'${procedure.name}')) # from line 9, col 13.
                            write(u'''_createRequest(''')
                            _v = VFFSL(SL,"procedure.input_args",True) # u'${procedure.input_args}' on line 9, col 45
...
''')
                            ...
                            write(u'''bool KRPCI::''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 11, col 13
...
''')
                        write(u'''{
  request.set_service("''')
                        _v = VFFSL(SL,"service.name",True) # u'${service.name}' on line 14, col 24
                        if _v is not None: write(_filter(_v, rawExpr=u'${service.name}')) # from line 14, col 24.
                        write(u'''");
  request.set_procedure("''')
                        _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 15, col 26
                        if _v is not None: write(_filter(_v, rawExpr=u'${procedure.name}')) # from line 15, col 26.
                        write(u'''");
''')
                        if VFFSL(SL,"procedure.parameters",True) != []: # generated from line 16, col 1
...
bool KRPCI::''')
                        _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 59, col 13
                        if _v is not None: write(_filter(_v, rawExpr=u'${procedure.name}')) # from line 59, col 13.
                        write(u'''(''')
                        _v = VFFSL(SL,"procedure.args",True) # u'${procedure.args}' on line 59, col 31
...
''')
                        if VFFSL(SL,"procedure.parameters",True) != []: # generated from line 65, col 1
                            write(u'''  KRPCI::''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 66, col 10
                            if _v is not None: write(_filter(_v, rawExpr=u'${procedure.name}')) # from line 66, col 10.
                            write(u'''_createRequest(''')
                            _v = VFFSL(SL,"procedure.request_args",True) # u'${procedure.request_args}' on line 66, col 42
                            if _v is not None: write(_filter(_v, rawExpr=u'${procedure.request_args}')) # from line 66, col 42.
                            write(u''', request);
''')
                        else: # generated from line 67, col 1
                            write(u'''  KRPCI::''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 68, col 10
...
\t}
''')
                        if VFFSL(SL,"procedure.return_type",True) == "uint64": # generated from line 78, col 1
                            write(u'''      ''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 79, col 7
...
''')
                        elif VFFSL(SL,"procedure.return_type",True) == "KRPC.Tuple": # generated from line 80, col 1
                            write(u'''      ''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 81, col 7
                            if _v is not None: write(_filter(_v, rawExpr=u'${procedure.name}')) # from line 81, col 7.
                            write(u'''_parseResponse(response, x, y, z);
''')
                        elif VFFSL(SL,"procedure.return_type",True) == "KRPC.List": # generated from line 82, col 1
                            write(u'''      ''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 83, col 7
...
''')
                        elif VFFSL(SL,"procedure.return_type",True) == "double": # generated from line 84, col 1
                            write(u'''      ''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 85, col 7
                            if _v is not None: write(_filter(_v, rawExpr=u'${procedure.name}')) # from line 85, col 7.
                            write(u'''_parseResponse(response, return_value);
''')
                        elif VFFSL(SL,"procedure.return_type",True) == "float": # generated from line 86, col 1
                            write(u'''      ''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 87, col 7
...
''')
                        if VFFSL(SL,"procedure.output_args",True) != "": # generated from line 93, col 1
                            write(u'''bool KRPCI::''')
                            _v = VFFSL(SL,"procedure.name",True) # u'${procedure.name}' on line 94, col 13
                            ...
                            _v = VFFSL(SL,"procedure.output_args",True) # u'${procedure.output_args}' on line 94, col 70
                            if _v is not None: write(_filter(_v, rawExpr=u'${procedure.output_args}')) # from line 94, col 70.
                            write(u''')
{
''')
                            if VFFSL(SL,"procedure.return_type",True) == "uint64": # generated from line 96, col 1
                                write(u'''  KRPCI::DecodeVarint(return_value, 
\t\t      (char *)response.return_value().data(), 
\t\t      response.return_value().size());
''')
                            elif VFFSL(SL,"procedure.return_type",True) == "KRPC.Tuple": # generated from line 100, col 1
                                write(u'''  krpc::Tuple tuple;
  tuple.ParseFromString(response.return_value());
  KRPCI::DecodeTuple(tuple, x, y, z);
''')
                            elif VFFSL(SL,"procedure.return_type",True) == "KRPC.List": # generated from line 104, col 1
...
''')
                            elif VFFSL(SL,"procedure.return_type",True) == "double": # generated from line 115, col 1
                                write(u'''  return_value = 0.0;
  memcpy(&return_value, response.return_value().data(), response.return_value().size());
''')
                            elif VFFSL(SL,"procedure.return_type",True) == "float": # generated from line 118, col 1
                                write(u'''  return_value = 0.0;
  memcpy(&return_value, response.return_value().data(), response.return_value().size());
''')
                            write(u'''  return true;
